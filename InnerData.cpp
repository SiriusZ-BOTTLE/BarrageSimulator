...
Objects::HitObject objects_inner[EC2I(IOS::End_Objects)];
...
//    tmp=new ManipulableObject();
    tmp.name="Block_zero_blue";
    tmp.set_element(elements_inner_objects[IOS::Block_zero_blue]);
    ...
    tmp.property.init();//初始化(计算一些必要数据)
